...
public class UmpushPlugin implements MethodCallHandler {
    private static String TAG = "umpus_hplugin";
    public static UmpushPlugin instance;
    public final MethodChannel channel;
    private static Registrar registrar;

    public static void registerWith(Registrar registrar) {
        instance = new UmpushPlugin(registrar);
    }

    private UmpushPlugin(Registrar registrar) {
        Log.i(TAG, "UmpushPlugin registrar ");
        UmpushPlugin.registrar = registrar;
        MethodChannel channel = new MethodChannel(registrar.messenger(), "umpush");
    ...
    public void onMethodCall(MethodCall call, Result result) {
        Log.i(TAG, "UmpushPlugin onMethodCall: " + call.toString());
