...
public class UmengApplication extends io.flutter.app.FlutterApplication {
    ...
    public void onCreate() {
        super.onCreate();
        Log.d(TAG, "UMConfigure onCreate ");
        UMConfigure.setLogEnabled(true);
        // 初始化组件化基础库, 统计SDK/推送SDK/分享SDK都必须调用此初始化接口

        String appSecret = this.metaValue("UMENG_MESSAGE_SECRET");
        Log.d(TAG, "UMConfigure appSecret: " + appSecret);
        String appKey = this.metaValue("UMENG_APPKEY");
        Log.d(TAG, "UMConfigure appKey: " + appKey);
        String umengChannel = this.metaValue("UMENG_CHANNEL");
        Log.d(TAG, "UMConfigure umengChannel: " + umengChannel);
        //UMConfigure.init(this, UMConfigure.DEVICE_TYPE_PHONE, appSecret);
        //初始化组件化基础库, 统计SDK/推送SDK/分享SDK都必须调用此初始化接口
        UMConfigure.init(this, appKey, umengChannel, UMConfigure.DEVICE_TYPE_PHONE,
                appSecret);
        ...
        UmengNotificationClickHandler notificationClickHandler = new UmengNotificationClickHandler() {
            ...
            public void launchApp(Context context, UMessage uMessage) {
                ...
                UmpushPlugin.instance.channel.invokeMethod("onMessage", umengPushMsg, FLUTTER_METHOD_CALLBACK);
        ...
        pushAgent.register(new
                                   ...
                                   IUmengRegisterCallback() {
                                       ...
                                       public void onSuccess(String deviceToken) {
                                           ...
                                           if (UmpushPlugin.instance != null) {
                                               //Flutter插件已经初始化完成，可以直接调用
                                               UmpushPlugin.instance.channel.invokeMethod("onToken", deviceToken, FLUTTER_METHOD_CALLBACK);
